...
file(GLOB_RECURSE files lib/*.h lib/*.cpp lib/*.cc *.cpp )
...
foreach(file IN LISTS files)
  add_custom_command(OUTPUT check-format${i}
    COMMAND ${CLANGFORMAT_COMMAND} ${file} | diff -u ${file} -
    VERBATIM
    COMMENT "Checking format of ${file}..."
  )
  list(APPEND check_format_depends "check-format${i}")

  add_custom_command(OUTPUT update-format${i}
    COMMAND ${CLANGFORMAT_COMMAND} -i ${file}
    VERBATIM
    COMMENT "Updating format of ${file}..."
  )
  list(APPEND update_format_depends "update-format${i}")
